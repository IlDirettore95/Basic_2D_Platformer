...
namespace GMDG.Basic2DPlatformer.Tools.XML
{
    public class Utils
    {
        ...
        public static XmlElement CreateTileElement(XmlDocument xmlDocument)
        {
            ...
            XmlAttribute nIn = xmlDocument.CreateAttribute("N_IN");
            XmlAttribute nOut = xmlDocument.CreateAttribute("N_OUT");
            XmlAttribute eIn = xmlDocument.CreateAttribute("E_IN");
            XmlAttribute eOut = xmlDocument.CreateAttribute("E_OUT");
            XmlAttribute sIn = xmlDocument.CreateAttribute("S_IN");
            XmlAttribute sOut = xmlDocument.CreateAttribute("S_OUT");
            XmlAttribute wIn = xmlDocument.CreateAttribute("W_IN");
            XmlAttribute wOut = xmlDocument.CreateAttribute("W_OUT");
            ...
            tile.Attributes.Append(nIn);
            tile.Attributes.Append(nOut);
            tile.Attributes.Append(eIn);
            tile.Attributes.Append(eOut);
            tile.Attributes.Append(sIn);
            tile.Attributes.Append(sOut);
            tile.Attributes.Append(wIn);
            tile.Attributes.Append(wOut);
